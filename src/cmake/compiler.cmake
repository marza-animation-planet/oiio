...
if (HIDE_SYMBOLS AND NOT DEBUGMODE AND (CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_CLANG))
    ...
    elseif (CMAKE_SYSTEM_NAME STREQUAL "Darwin")
        if (NOT VISIBILITY_MAP_FILE)
            set (VISIBILITY_MAP_FILE "${PROJECT_SOURCE_DIR}/src/build-scripts/exportsymbols_osx.map")
        endif ()
        ...
        if (NOT PY_VISIBILITY_MAP_FILE)
            set (PY_VISIBILITY_MAP_FILE "${PROJECT_SOURCE_DIR}/src/build-scripts/exportsymbols_python_osx.map")
        endif ()
        set (PY_VISIBILITY_MAP_COMMAND "-Wl,-exported_symbols_list,${PY_VISIBILITY_MAP_FILE}")
        if (VERBOSE)
            message (STATUS "PY_VISIBILITY_MAP_COMMAND = ${PY_VISIBILITY_MAP_COMMAND}")
        endif ()
    endif ()
