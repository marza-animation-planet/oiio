...
if (OpenColorIO_FOUND AND LINKSTATIC)
    # Is this necessary?
    set (OPENCOLORIO_DEFINITIONS ${OPENCOLORIO_DEFINITIONS} "-DOpenColorIO_STATIC" "-DOpenColorIO_SKIP_IMPORTS")
    ...
    if (EXPAT_LIBRARY)
        set (OPENCOLORIO_LIBRARIES "${OPENCOLORIO_LIBRARIES};${EXPAT_LIBRARY}" CACHE STRING "" FORCE)
    endif ()
    ...
    if (APPLE AND OPENCOLORIO_VERSION VERSION_GREATER_EQUAL 2.0.0)
        set (OPENCOLORIO_LIBRARIES "${OPENCOLORIO_LIBRARIES};-framework Carbon;-framework IOKit" CACHE STRING "" FORCE)
    endif ()
endif ()